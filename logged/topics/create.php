...
<html lang="en">
    ...
    <!-- Gbody start -->
     <div class="main-container">           
         ...
         <?php  if (isset($_SESSION['logining']) && $_SESSION['logining'] === true): ?>                        
            <form id="myformPosts" class="flexible coloums bc-white form-c" autocomplete="off">
                <h2 class="t-c">Create-Topic</h2>
                ...
                <div class="m-t">
                    <input type="checkbox" name="createTopics" id="published"> Not Deleted
                </div>
    ...
    <script>
       $(document).ready(function () {
           $('#myformPosts').on('submit',function (e) {
               e.preventDefault();
